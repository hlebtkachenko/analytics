...
const reviewedImports = {
  ...
  'app/(product)/documents/analytics/page.tsx': ['DocumentAdd'],
  'app/(product)/documents/page.tsx': ['DocumentAdd'],
  'app/(product)/inbox/page.tsx': [
    'DataSet',
    'DataTable',
    'Document',
    'DocumentPdf',
  ...
  'app/(product)/workspaces/workspace-list.tsx': ['Add'],
...
const reviewedCallsites = [
  ...
  [
    'app/(product)/documents/analytics/page.tsx',
    'Button',
    'DocumentAdd',
  ...
  [
    'app/(product)/workspaces/workspace-list.tsx',
    'Button',
    'Add',
