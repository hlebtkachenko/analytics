...
type WorkspaceFilterFlyoutProps = Readonly<{
  applyLabel: string;
...
// Category columns of checkboxes over a two-button footer. Selection stays
// staged until the caller applies it. Kept local to the workspaces page.
export function WorkspaceFilterFlyout({
  applyLabel,
  groups,
  idPrefix,
  onApply,
