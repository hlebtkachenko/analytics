...
const name = 'unstable_TextDirection';
...
const meta = {
  argTypes: {
    ...
    getTextDirection: {
      control: false,
      description: 'Public prop: GetTextDirection | undefined',
      table: {
        type: {
          summary: 'GetTextDirection | undefined',
        },
      },
    },
  },
  ...
  title: 'Components/unstable/unstable_TextDirection',
} satisfies Meta;
