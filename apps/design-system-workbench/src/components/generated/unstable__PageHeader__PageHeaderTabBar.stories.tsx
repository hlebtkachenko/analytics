...
const name = 'unstable__PageHeader.PageHeaderTabBar';
...
const meta = {
  argTypes: {
    ...
    tags: {
      ...
      description: 'Public prop: TagItem[] | undefined',
      table: {
        type: {
          summary: 'TagItem[] | undefined',
        },
      },
    },
  },
  ...
  title: 'Components/unstable/unstable__PageHeader.PageHeaderTabBar',
} satisfies Meta;
