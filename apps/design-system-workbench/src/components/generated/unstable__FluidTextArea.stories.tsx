...
const name = 'unstable__FluidTextArea';
...
const meta = {
  argTypes: {
    ...
    onChange: {
      ...
      table: {
        type: {
          summary:
            'React.ChangeEventHandler<HTMLTextAreaElement, Element> | undefined',
        },
      },
    },
    onClick: {
      ...
      table: {
        type: {
          summary: 'React.MouseEventHandler<HTMLTextAreaElement> | undefined',
        },
      },
    },
    placeholder: {
  ...
  title: 'Components/unstable/unstable__FluidTextArea',
} satisfies Meta;
