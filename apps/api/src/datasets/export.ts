...
// Semicolon is quoted too: a locale whose list separator is ';' would otherwise split an unquoted cell and hand the next field an evaluable lead. Quoting is lossless, so this costs nothing.
