...
| Large virtualized lists   | Defer `@tanstack/react-virtual`   | Carbon DataTable with server pagination is the accessible default. Add virtualization only after measured dense-scrolling pressure and dedicated keyboard/screen-reader tests.   |
